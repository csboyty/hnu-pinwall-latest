...
from caching import Cache as _Cache, CacheRegistry
...
class Service(object):
    """
        ...
        operation in the context of a :class:`Flask` application
    """
    __model__ = None
    ...
    def all(self):
        """Returns a generator containing all instance of the service's model
        """
        return self.__model__.query.all()

    def get(self, id):
        """Returns an instance of the service's model with the specified id
        Returns `None` if an instance with the specified id doesn't exist.
        :param id: the instance id
        """
        return self.__model__.query.get(id)

    def get_all(self, *ids):
        """Return a list of instances of the service's model with the specified ids
        :param *ids" instance ids
        """
        return self.__model__.query.filter(self.__model__.id.in_(ids)).all()

    def find(self, **kwargs):
        """Return a list of instances of the service's model filtered by the
    ...
    def get_or_404(self, id):
        ...
        raises an 404 error if an instance with the specified id doesn't exist.
